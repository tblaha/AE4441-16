...
if cfg.grid_setting == 1:
    ...
    grid.loc["RonneNord"]    = [14.707778, 55.111111, 1500, "60kV", "Pink", 200]
    grid.loc["RonneSyd"]     = [14.730556, 55.089722, 1500, "60kV", "Pink", 200]
    ...
    grid_links_base.loc[0] = [0, "Ronne", "RonneSyd", 10000]
    grid_links_base.loc[1] = [1, "Ronne", "RonneNord", 10000]
    grid_links_base.loc[2] = [2, "Ronne", "Vesthavnen", 10000]
    grid_links_base.loc[3] = [3, "Ronne", "Snorrebakken", 10000]
    grid_links_base.loc[4] = [4, "RonneNord", "Hasle", 10000]
    grid_links_base.loc[5] = [5, "Snorrebakken", "Hasle", 10000]
    grid_links_base.loc[6] = [6, "RonneSyd", "Akirkeby", 10000]
